...
describe('forms filter', () => {
  ...
  const CustomFieldContextOptionInstance = new InstanceElement(
    'project1',
            ...
            conditions: {
              10: {
                ...
                i: {
                  co: {
                    cIds: {
                      2: [new ReferenceExpression(CustomFieldContextOptionInstance.elemID, CustomFieldContextOptionInstance)],
                    },
                  },
                },
                o: {
  ...
  describe('onDeploy', () => {
    ...
    it('should return the conditions field to its modified structure', async () => {
      await filter.onDeploy([{ action: 'add', data: { after: formInstance } }])
      expect(formInstance.value.design.conditions).toEqual({'10': {'i': {'co': {'cIds': [{'key': '2', 'value': ['2']}]}}, 'o': [{'key': 'sIds', 'value': ['1']}], 't': 'sh'}})
